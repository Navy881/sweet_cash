...
from sweet_cash.types.notifications_events import Event, EventType, PartisipantsGotRoleData
...
class SendPartisipantGotRoleEvent(object):
    def __init__(self,
                 user_id: int,
    ...
    async def __call__(self, event_id: Event, user_id: int, role: EventParticipantRole) -> None:
        ...
        event_data = PartisipantsGotRoleData(
            user_id=user_id,
            event_id=event_id,
        ...
        async with self.events_participants_repository.transaction():
            ...
            for user_id in user_ids:
                ...
                event = Event(
                    ...
                    event_type=EventType.PARTISIPANT_GOT_ROLE.value,
                    for_user_id=user_id,
                    data=event_data
                )
